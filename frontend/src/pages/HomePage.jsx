...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#0a0a0b] via-[#121214] to-[#0a0a0b]">
      ...
      <footer className="bg-[#0f0f10] border-t border-gray-800 pt-20 pb-8 px-4 sm:pt-24 sm:pb-12 sm:px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="border-t border-gray-800 mt-8 pt-4 sm:mt-10 sm:pt-6 flex flex-col sm:flex-row justify-between items-center gap-3 sm:gap-4">
