...
const HomePage = () => {
  ...
  // TEK VE TEMİZ FONKSİYON
  const handleContinue = async () => {
    if (username.trim() && sessionId) {
      setIsSubmitting(true); // Butonu kilitledik
      ...
      try {
        ...
        setIsSubmitting(false); // İşlem bitince butonu tekrar aç
          ...
          <div className="text-center mb-6 sm:mb-8">
            ...
            <div className="flex justify-center gap-8 sm:gap-12">
              <div className="flex flex-col items-center">
                <button className="bg-transparent border-2 border-blue-500 text-white px-4 sm:px-6 py-2 rounded-md hover:bg-500 transition-all text-xs sm:text-sm font-semibold mb-4">App Store</button>
              ...
              <div className="flex flex-col items-center">
                <button className="bg-transparent border-2 border-gray-600 text-white px-4 sm:px-6 py-2 rounded-md hover:bg-gray-700 transition-all text-xs sm:text-sm font-semibold mb-4">Google Play</button>
                <div className="text-left">
